...
public class GamePanel extends JPanel {
    ...
    public GamePanel(FlappyBird fb, Bird bird, ArrayList<Rectangle> rects) {
        ...
        pauseFont = new Font("Arial", Font.BOLD, 44);
    ...
    public void paintComponent(Graphics g) {
        ...
        g.drawString("High Score: " + fb.getHighScore(),this.getWidth()/11*8,20);
        ...
        if(fb.paused()) {
            ...
            g.drawString("PRESS SPACE TO BEGIN", FlappyBird.WIDTH/2-300, FlappyBird.HEIGHT/2+60);
            g.setFont(scoreFont);
            g.drawString("PRESS M FOR THE MODE MENU", FlappyBird.WIDTH/2-160, FlappyBird.HEIGHT/5*3+50);
